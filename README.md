...
<ol>
<li><strong>Inicialização</strong>: Ao iniciar o jogo, o menu principal será exibido, apresentando o nome "Tetris", as opções de iniciar e sair.</li>
...
<p>Para exibir imagens na tela, foi desenvolvida uma biblioteca em Assembly ARMv7 que atua como um driver para o processador gráfico, controlando a saída VGA e desenhando pixels diretamente no display. Este código em assembly aproveita a arquitetura ARMv7 do processador Cortex-A9 integrado ao kit DE1-SoC, permitindo controle eficiente sobre o hardware gráfico e reduzindo a latência na atualização da tela. Utilizar Assembly ARMv7 neste contexto foi essencial para otimizar o desempenho do jogo e garantir uma resposta visual suave e precisa.</p>
